    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-9\">
            <div class=\"col border rounded p-2\">
                ...
                ";
        // line 16
        echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["products"]) || array_key_exists("products", $context) ? $context["products"] : (function () { throw new RuntimeError('Variable "products" does not exist.', 16, $this->source); })()));
        echo "
            </div>
        </div>
...
";
    ...
    {
        return array (  103 => 16,  97 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "front_end/profile/cart.html.twig", "D:\\data\\Documents\\projecten\\symfony5_webshop\\webshopV1\\templates\\front_end\\profile\\cart.html.twig");
    }
}
