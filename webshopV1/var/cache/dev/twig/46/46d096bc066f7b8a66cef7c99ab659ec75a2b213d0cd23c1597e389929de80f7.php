...
class __TwigTemplate_f19a0a5a46b19f4b673914f414d9bd69f8b6cee85828f059dcbda83b7429534e extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<p class=\"nav-link\" href=\"#\"><a style=\"color:grey; text-decoration:none\" class=\"";
        // line 33
        if ((twig_get_attribute($this->env, $this->source, ($context["params"] ?? null), "_locale", [], "any", true, true, false, 33) && (twig_get_attribute($this->env, $this->source, (isset($context["params"]) || array_key_exists("params", $context) ? $context["params"] : (function () { throw new RuntimeError('Variable "params" does not exist.', 33, $this->source); })()), "_locale", [], "any", false, false, false, 33) == "nl"))) {
            echo "fw-bold";
        }
        echo "\" href=\"";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath((isset($context["route"]) || array_key_exists("route", $context) ? $context["route"] : (function () { throw new RuntimeError('Variable "route" does not exist.', 33, $this->source); })()), twig_array_merge((isset($context["params"]) || array_key_exists("params", $context) ? $context["params"] : (function () { throw new RuntimeError('Variable "params" does not exist.', 33, $this->source); })()), ["_locale" => "nl"])), "html", null, true);
        echo "\">NL</a> | <a style=\"color:grey; text-decoration:none\" class=\"";
        if (( !twig_get_attribute($this->env, $this->source, ($context["params"] ?? null), "_locale", [], "any", true, true, false, 33) || (twig_get_attribute($this->env, $this->source, (isset($context["params"]) || array_key_exists("params", $context) ? $context["params"] : (function () { throw new RuntimeError('Variable "params" does not exist.', 33, $this->source); })()), "_locale", [], "any", false, false, false, 33) == "en"))) {
            echo "fw-bold";
        }
        echo "\" href=\"";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath((isset($context["route"]) || array_key_exists("route", $context) ? $context["route"] : (function () { throw new RuntimeError('Variable "route" does not exist.', 33, $this->source); })()), twig_array_merge((isset($context["params"]) || array_key_exists("params", $context) ? $context["params"] : (function () { throw new RuntimeError('Variable "params" does not exist.', 33, $this->source); })()), ["_locale" => "en"])), "html", null, true);
        echo "\">EN</a></p>
\t\t\t</li>
\t\t</ul>
\t</div>
    ...
    {
        return array (  115 => 33,  110 => 30,  102 => 28,  94 => 26,  92 => 25,  88 => 23,  82 => 19,  80 => 18,  78 => 17,  74 => 16,  71 => 15,  68 => 14,  60 => 10,  54 => 7,  49 => 4,  47 => 3,  45 => 2,  43 => 1,);
    }
